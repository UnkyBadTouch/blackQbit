...
- Naming (2026-08-04): APK is `blackQbit-v{versionName}.{versionCode}.apk`, not `blackQbit-debug.apk` — kept distinct from the unrelated `~/blackAria2` project's own `blackAria2-*.apk`. Tracked in git and pushed to GitHub (as of 2026-08-04), same as blackAria2.
